function [p, HSIC] = fasthsic(X,Y,sX,sY,nrperm)
% function [p, HSIC] = fasthsic(X,Y,sX,sY,nrperm)
%
...
%                    NOTE: CURRENTLY ONLY nrperm==0 is supported in this MatLab fallback
%
...
%
  ...
  if nargin == 5
    if nrperm ~= 0
      error('The MatLab implementation of fastHSIC only supports nrperm == 0.');
    end
  end
